...
import json
import time
import requests  # For optional web notifications

class HeadlessFaceAccessControl:
    def __init__(self):
    ...
    def run(self):
        print("[INFO] Starting Headless Face Access Control System")
...
def main():
    ...
    system = HeadlessFaceAccessControl()
    system.run()
